...
const ClearQuery = () => {
  ...
  return (
    <Button
        ...
        className="flex flex-col items-center gap-0 text-[0.65rem] sm:text-[0.7rem] md:text-xs !rounded-none border-r-0 border-b-0 !bg-background !font-normal text-[#FF8C00]" 
    >

...
const RunQuery = () => {
  ...
  return (
    <Button
        ...
        className="w-[85px] sm:w-[90px] xl:w-[100px] flex flex-col items-center gap-0 text-[0.65rem] sm:text-[0.7rem] lg:text-xs !rounded-none border-r-0 border-b-0 !bg-background  !font-normal "
    >
        <span className="text-[#FF8C00] font-medium">Run Query</span>
        <span className="text-[0.55rem] text-[#aaa] hidden sm:block ">Alt + X</span>
  </Button>
  )
}

...
import SchemaTableList from "@/components/features/schema-table-list";
          ...
          <div className="flex items-center gap-4 sm:gap-5 w-fit">
            <Sheet>
                ...
                <SheetContent className="w-full sm:max-w-[500px] gap-0">
                  <SheetHeader>
                     <SheetTitle className="flex items-center gap-2 text-xs xl:text-xs">  <Database className="w-4 h-4 shrink-0" /> SCHEMA</SheetTitle>
                  </SheetHeader>
